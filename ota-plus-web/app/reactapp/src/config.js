...
export const DROPDOWN_TOGGLE_ICON = '/assets/img/new-app/16/LUI-icon-pd-overflow_vert_center-solid-16.svg';
...
export const SOFTWARE_ICON_UPLOADING_STATUS_ERROR = '/assets/img/new-app/24/uploading-software-failed.svg';
export const SOFTWARE_ICON_UPLOADING_STATUS_SUCCESS = '/assets/img/new-app/24/LUI-icon-pd-confirm-outline.svg';
